...
/*
*
* Template Name: Home DuPage West Cook
*
				...
				<div id="inner-content" class="wrap clearfix">
					...
					<div class="action-wrap twelvecol clearfix"><!-- woefully unsemantic but it really just is a wrapper div to clear floats -->
						...
						<div class="action"><!-- includes the slider, call-to-action buttons, and social buttons -->
				    		...
				    		<?php echo do_shortcode('[nivoslider slug="dwc-slider"]'); ?>
                 	...
                 	<article class="home-buttons button-nav clearfix">
				    			<ul class="clearfix">
				    				...
				    				<li class="button-nav-2"><a href="/dupagewestcook/live-united-5k/"><img src="<?php echo get_template_directory_uri(); ?>/library/images/dwc_5k.png" data-at2x="http://static.uw-mc.org/wp-content/themes/uwchilipepper/library/images/dwc_5k@2x.png"></a></li>
				    				<li class="button-nav-3"><a href="/yls/"><img src="<?php echo get_template_directory_uri(); ?>/library/images/yls_yellow.png" data-at2x="http://static.uw-mc.org/wp-content/themes/uwchilipepper/library/images/yls_yellow@2x.png"></a></li>
									<li class="button-nav-4"><a href="/dupagewestcook/southeast-dupage-health-initiative/"><img src="<?php echo get_template_directory_uri(); ?>/library/images/dwc_sdhi.png" data-at2x="http://static.uw-mc.org/wp-content/themes/uwchilipepper/library/images/dwc_sdhi@2x.png"></a></li>
				    				<li class="button-nav-5"><a href="/dupagewestcook/board-governance/"><img src="<?php echo get_template_directory_uri(); ?>/library/images/board_governance.png" data-at2x="http://static.uw-mc.org/wp-content/themes/uwchilipepper/library/images/board_governance@2x.png"></a></li>
				    				<li class="button-nav-6"><a href="/dupagewestcook/meet-the-uwdwc-staff/"><img src="<?php echo get_template_directory_uri(); ?>/library/images/meet_the_staff2.png" data-at2x="http://static.uw-mc.org/wp-content/themes/uwchilipepper/library/images/meet_the_staff2@2x.png"></a></li>
				    				<li class="button-nav-7 last-right"><a href="/dupagewestcook/contact-dupagewest-cook/"><img src="<?php echo get_template_directory_uri(); ?>/library/images/contact_us.png" data-at2x="http://static.uw-mc.org/wp-content/themes/uwchilipepper/library/images/contact_us@2x.png"></a></li>
				    			</ul>
				    </article>
...
<p>United Way of DuPage/West Cook is part of a network of support for <span class="trade">LIVE UNITED 2020</span>, our community-impact plan for Chicagoland.</p>

<p>United Way of DuPage/West Cook serves an increasingly diverse population. Every township in this region has experienced a decrease in white populations and an increase in Latino populations.</p>
<ul class="list-square">
<li>DuPage/West Cook’s unemployment rate fluctuates greatly. Starting with an average of about 3.8% at the beginning of the millennium, that rate has more than doubled to 9% in 2010.</li>
<li>New foreclosure filings have more than doubled, especially in the second half of the decade.</li>
<li>The percentage of low-income residents has increased by more than 50%, compared to the total population increase of 4% during the same period.</li>
</ul>                 				</section>
