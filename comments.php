...
<?php if ( have_comments() ) : ?>
	<h3 id="comments"><span style="color:#999;"><?php comments_number(__('<span>No</span> comments', 'bonestheme'), __('<span>One</span> Comment', 'bonestheme'), _n('<span>%</span> Comment', '<span>%</span> Comments', get_comments_number(),'bonestheme') );?></h3>
...
<section id="respond" class="respond-form">
	...
	<h3 id="comment-form-title" class="h2"><?php comment_form_title( __('Leave a Comment', 'bonestheme'), __('Leave a Reply to %s', 'bonestheme' )); ?>&nbsp;&nbsp;<span class="icon-bubbles-2 small"></span></h3>
	...
	<p class="comments-logged-in-as byline small-caps"><?php _e("Logged in as", "bonestheme"); ?> <a href="<?php echo get_option('siteurl'); ?>/wp-admin/profile.php"><?php echo $user_identity; ?></a>. <a href="<?php echo wp_logout_url(get_permalink()); ?>" title="<?php _e("Log out of this account", "bonestheme"); ?>"><?php _e("Log out", "bonestheme"); ?> <?php _e("&raquo;", "bonestheme"); ?></a></p>
...
-->
	...
	<p><textarea name="comment" id="comment" placeholder="<?php _e('Add your comment...', 'bonestheme'); ?>" tabindex="4"></textarea></p>
	
	<p>
	  <button name="submit" type="submit" id="submit" class="button btn btn-primary post-comment" tabindex="5" value=""/><span class="icon-bubble"></span> Post Comment</button>
	  <?php comment_id_fields(); ?>
	</p>
	
	<div class="comment-tags">
		<p id="allowed_tags" class="small"><?php _e('You can use these tags in your comment', 'bonestheme'); ?>: <pre><?php echo allowed_tags(); ?></pre></p>
	</div>
