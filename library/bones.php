...
function bones_theme_support() {
	...
	register_nav_menus(
		array(
			...
			'nws-nav' => __( 'NWS Menu', 'bonestheme'), // custom NWS nav menu (for sidebar)
			'e-way-nav' => __( 'E-Way', 'bonestheme')
		)
	);
...
function uwmc_mobile_nav() {
	// display the wp3 menu if available
    wp_nav_menu(array(
    	'container' => false,                           // remove nav container
    	'container_class' => 'menu clearfix',           // class of container (should you choose to use it)
    	'menu' => __( 'Mobile Menu', 'bonestheme' ),  // nav name
    	'menu_class' => 'primary-nav mobile-nav clearfix',         // adding custom nav class
...
function eway_nav() {
    ...
    wp_nav_menu(array(
    	'container' => false,                           // remove nav container
    	'container_class' => 'menu clearfix',           // class of container (should you choose to use it)
    	'menu' => __( 'E-Way', 'bonestheme' ),  // nav name
    	'menu_class' => 'e-way-nav nav top-nav clearfix',         // adding custom nav class
    	'theme_location' => 'e-way-nav',                 // where it's located in the theme
    	'before' => '',                                 // before the menu
        'after' => '',                                  // after the menu
        'link_before' => '',                            // before each link
        'link_after' => '',                             // after each link
...
function bones_excerpt_more($more) {
	...
	return '...  <a class="action-link" href="'. get_permalink($post->ID) . '" title="Read '.get_the_title($post->ID).'">Read more &raquo;</a>';
}
