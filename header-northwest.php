		...
		<div class="beforecontainer"><!-- start beforecontainer: includes UWMC network nav and email signup -->
			...
			<header class="header" role="banner">
				...
				<div id="inner-header" class="wrap clearfix">
					...
					<div id="logo"><a href="<?php echo home_url(); ?>" rel="nofollow"><img src="<?php echo get_template_directory_uri(); ?>/library/images/							logo.png"></a><span>Northwest Suburban<br>United Way</span></div><!-- site logo for tablets and above -->
