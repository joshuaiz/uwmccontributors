		...
		<div class="beforecontainer"><!-- start beforecontainer: includes UWMC network nav and email signup -->
			...
			<header class="header" role="banner">
				...
				<div id="inner-header" class="wrap clearfix">
					...
					<div id="logo-mobile"><a href="<?php echo home_url(); ?>" rel="nofollow"><img src="<?php echo get_template_directory_uri(); ?>/library/images/					logo-mobile2.png"></a></div><!-- Hidden for 768px widths and above -->
					
					<div id="logo"><a href="<?php echo home_url(); ?>" rel="nofollow"><img src="<?php echo get_template_directory_uri(); ?>/library/images/							logo.png"></a><span>United Way of<br>DuPage/West Cook</span></div><!-- site logo for tablets and above -->
