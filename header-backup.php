...
<!--[if gt IE 8]><!--> <html <?php language_attributes(); ?> class="no-js"><!--<![endif]-->
	...
	<head>
		...
		<link rel="shortcut icon" href="<?php echo get_template_directory_uri(); ?>/favicon.ico">
  		...
  		<link type="text/css" rel="stylesheet" href="http://fast.fonts.com/cssapi/3f2542b6-eb6e-4ca9-a8cf-c3572d6adca6.css"/>
		...
		<div class="beforecontainer"><? /* start beforecontainer: includes UWMC network nav and email signup */ ?>
       	 	...
       	 	<? /* BEGIN: Constant Contact Basic Opt-in Email List Form */ ?>
	       	 	<div class="email-signup">
	       	 		...
	       	 		<form name="ccoptin" action="http://visitor.r20.constantcontact.com/d.jsp" target="_blank" method="post" style="margin-bottom:2;">
	       	 			...
	       	 			<input id="constant-contact-email" type="text" name="ea" size="35" placeholder="ENTER YOUR EMAIL &amp; JOIN THE MOVEMENT" style="font-size:12px; padding-left: 5px;color: #969696;height:22px;">
	       	 			
	       	 			<input id="constant-contact-submit" type="submit" name="join" value="Join" class="submit flatbutton" style="font-family:'ff-meta-web-pro','Meta',Trebuchet MS, Trebuchet, Helvetica, Arial, sans-serif; font-size:10px;">
	       	 				...
	       	 				jQuery('input#constant-contact-email').focus(function() {
	       	 				    ...
	       	 				    if ($(this).val() == $(this).data('Enter Your Email &amp; Join the Movement')) {
	       	 				        $(this).val('');
	       	 				    }
	       	 				}).blur(function(){
	       	 				    if ($(this).val() == '') {
	       	 				        $(this).val($(this).data('Enter Your Email &amp; Join the Movement'));
	       	 				    }
	       	 				});
	       	 				</script>
	       	 		</form>
			...
			<header class="header" role="banner">
				...
				<div id="inner-header" class="wrap clearfix">
					...
					<div id="logo-mobile"><a href="<?php echo home_url(); ?>" rel="nofollow"><img src="<?php echo get_template_directory_uri(); ?>/library/images/logo-mobile2.png" data-at2x="http://static.uw-mc.org/wp-content/themes/uwchilipepper/library/images/logo-mobile2@2x.png"></a></div><?php /* Hidden for 768px widths and above */ ?>
					
					<div id="logo"><a href="<?php echo home_url(); ?>" rel="nofollow"><img src="<?php echo get_template_directory_uri(); ?>/library/images/logo.png" data-at2x="http://static.uw-mc.org/wp-content/themes/uwchilipepper/library/images/logo@2x.png"></a><span>United Way of<br>Metropolitan Chicago</span></div><?php /* site logo for tablets and above */ ?>
					...
					<div class="cta-buttons">
						<ul class="nostyle">
							...
							<li><a class="cta-advocate" href="http://uw-mc.org/get-involved/advocate"><span class="icon-advocate"></span>Advocate.</a></li>
							<li><a class="cta-volunteer" href="http://uw-mc.org/get-involved/volunteer"><span class="icon-volunteer"></span>Volunteer.</a></li>
						</ul>
					</div>
					<div class="sub-page-search">
					<form method="get" id="searchform" action="<?php echo esc_url( home_url( '/' ) ); ?>">
						<?php /* <label for="s" class="assistive-text"><?php _e( 'Search', 'bones' ); ?></label> */ ?>
						<input type="search" results class="field" name="s" id="s" placeholder="<?php esc_attr_e( 'SEARCH UWMC', 'bones' ); ?>" />
